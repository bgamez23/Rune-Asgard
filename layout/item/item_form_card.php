...
$output .= '
  ...
  <table class="whitetable" cellspacing="1">
    ...
    <tr class="grayrow">
      <td rowspan="5" style="width: 135px; height: 180px;"><img src="' . $this->fCard . '" onclick="cardPopUp(\'' . Settings::get('main', 'db_res_paths', 'card2') . '/' . $this->getAttr('id') .  '.' . Settings::get('main', 'file_types', 'card2') . '\')" alt="Image" /></td>
