<?php if(!defined('EFFICIENT_ROOT')) exit();
  ...
  return array (
    ...
    'drop_rates'  =>  array (
      ...
      'item_rate_equip' =>  1,
      'item_rate_card'  =>  1,
      'item_rate_mvp'   =>  1, // Overrides all, although I'm not sure if this is the proper way to do it... (should it multiply with the other values? either way it's fine for 1x servers)
    ),
