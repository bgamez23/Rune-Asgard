<?php
  ...
  define('PAGE_TITLE', 'Ragnarok Database Online ~ ' . ((Settings::get('interface', 'groups', GROUP_ID, 'name') !== FALSE && GROUP_ID != 0) ? '&raquo; ' . Settings::get('interface', 'groups', GROUP_ID, 'name') : '' ));
